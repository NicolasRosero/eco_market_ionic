...
export class RegisterPage implements OnInit, OnDestroy {
  ...
  async submit(): Promise<void> {
    ...
    if(isValid) {
      const resp = await this.saveRegisterData();
  ...
  async saveRegisterData(): Promise<AuthUserResp> {
    const userToSave: User = {
      ...
      userAgreeTerms: this.registerForm.controls['agreeTerms'].value
    };

    return await this.authService.register(userToSave);
  }
